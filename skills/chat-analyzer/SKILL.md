...
name: chat-analyzer
description: >
  Deep conversation analyzer that reveals the true dynamics of any text chat. Understand
  power balance, emotional shifts, interest levels, and manipulation patterns across
  entire conversation threads. Spots passive aggressive behavior, gaslighting, love
  bombing, breadcrumbing, and other toxic communication patterns. Measures emotional
  intelligence and empathy in dialogues. Analyzes WeChat, WhatsApp, iMessage, Slack,
  Telegram, and dating app conversations. Get clarity on what's really happening.
metadata:
  openclaw:
    emoji: "🧠"
---
